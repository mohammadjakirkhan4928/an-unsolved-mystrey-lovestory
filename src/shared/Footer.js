...
const Footer = () => {
  return (
    <div className="px-5 py-16 bg-primary grid md:grid-cols-2  rounded-t-2xl">
    <div>
      <div className="avatar">
        <div className="w-16 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
          <img
          src="https://i.ibb.co/Prf8KR2/kb.png"
          // src='.././assets/kb.png'
          alt="jakir" />
        </div>
      </div>
      <div>
        <h3 className="text-xl text-white mt-2">
          ...
          <span className="text-warning font-bold">모하마드 자키르 칸</span>
        </h3>
        <p className="text-base-300 mt-3">
          ...
          <span className="text-error underline">
